...
The build specification, including the invariants every change must respect, is
[`AI/ROADMAP.md`](../AI/ROADMAP.md). Decisions that extend or contradict it are logged in
[`DECISIONS.md`](../DECISIONS.md).

## Licence

This documentation is CC BY 4.0. See [LICENSE](LICENSE). The code is Apache-2.0.
